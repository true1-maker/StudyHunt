...
function showToast(message, type = 'success', duration = 3000) {
  ...
  // ১. আইকনগুলোকে Lucide ট্যাগ দিয়ে সাজানো
const icons = { 
...
// ২. ইনার এইচটিএমএল সেট করা
toast.innerHTML = `<span>${icons[type] || '<i data-lucide="bell"></i>'}</span><span>${message}</span>`;

// ৩. টোস্ট অ্যাপেন্ড করার ঠিক পরেই আইকন রেন্ডার করা (খুবই জরুরি)
